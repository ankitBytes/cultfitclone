import { CardActionArea, Grid,Typography,CardMedia,Card,CardContent } from '@mui/material';
    ...
    return <div>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            Join podcast host ,deepak in his quest to build a fitness habit for life.tune in every weekday for health.
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            it's time to say goodbye to the physical and mental stress brought upon by this virus.this program focusses 
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            this is a combination of 3 different styles of running making it fun a clear working workout to clear ur mind 
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            it is an powerful practise which has a profound effect on you body and mind to reduce stress and anxiety
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            the language is simple and engaging and something thet would captures a child's imagination journey.
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            This series will help you relax to drift into a peaceful and deep sleep,many stories are there for peaceful sleep
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            Music for the mind ! stress ,sleep or focus ,let Music cover it all with an ambient touch with sounds of nature
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            The world are facing an unprecedented situation and we all are feeling the efforts pn our emotional health.
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            The program helps one walk throgh the series of steps in a comfortable posture with proper breathing
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            Continue your practice of meditation with less guidance and more silence.the right way for practice
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            the mother of all emotions ! created by this series will help you develop gratitude and thankfullness in life.
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            It will enhance and renew ur relation and help you heal from a breakup by connecting with love ,sympathy.
          </Typography>
        </CardContent>
      </CardActionArea>
    </Card>
